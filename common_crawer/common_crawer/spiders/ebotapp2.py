...
class EbotappSpider(scrapy.Spider):
    ...
    def main_parse(self, response):
        ...
        try:
            ...
            self.get_people(EnMovieID,film_data)  # 剧组人员
            self.get_company(EnMovieID,film_data)  # 相关公司
            try:
                if film_data['ReleaseDate'] != '':
                    try:
                        ...
                        if releaseDate < datetime.datetime.now():
                            ...
                            self.get_index(EnMovieID, sDate, eDate,film_data)  # 影响指数
                            self.get_distribute(EnMovieID, sDate, eDate, film_data['MovieID'],
                                                            film_data)  # 票房分布
                            self.get_boxOffice(EnMovieID, sDate, eDate, film_data['MovieID'],film_data)
                            self.get_audience(EnMovieID,film_data)  # 观众
                            self.get_rowPrice(EnMovieID, sDate, eDate, film_data['MovieID'],film_data)  # 排片
    ...
    def get_people(self, EnMovieID,film_data):
        try:
    ...
    def get_company(self, EnMovieID,film_data):
        try:
    ...
    def get_audience(self, EnMovieID,film_data):
        try:
    ...
    def get_index(self, EnMovieID, sDate, eDate,film_data):
        try:
    ...
    def get_boxOffice(self, EnMovieID, sDate, eDate, MovieID, film_data,Index='102,201,202,203,205,221,222,251,801,604,606',
                      ServicePrice=1):
        try:
    ...
    def get_rowPrice(self, EnMovieID, sDate, eDate, MovieID, film_data,Index='102,201,202,203,205,221,222,251,801,604,606',
                     ServicePrice=1):
        try:
